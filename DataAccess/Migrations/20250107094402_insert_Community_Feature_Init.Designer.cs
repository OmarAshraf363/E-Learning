...
namespace Banha_UniverCity.Migrations
{
    ...
    [Migration("20250107094402_insert_Community_Feature_Init")]
    partial class insert_Community_Feature_Init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BFCAI.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 7, 9, 44, 0, 433, DateTimeKind.Utc).AddTicks(1590),
                            PostId = 1,
                            UserId = "123548458"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 7, 9, 44, 0, 433, DateTimeKind.Utc).AddTicks(1594),
                            PostId = 1,
                            UserId = "123548458"
                        });
                });
            ...
            modelBuilder.Entity("BFCAI.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 7, 9, 44, 0, 433, DateTimeKind.Utc).AddTicks(1381),
                            UserId = "123548458"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 7, 9, 44, 0, 433, DateTimeKind.Utc).AddTicks(1385),
                            UserId = "123548458"
                        });
                });
            ...
            modelBuilder.Entity("Banha_UniverCity.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 1,
                            FeedbackDate = new DateTime(2025, 1, 7, 11, 44, 0, 432, DateTimeKind.Local).AddTicks(8011),
                            ProviderUserId = "1",
                        ...
                        new
                        {
                            ...
                            CourseId = 2,
                            FeedbackDate = new DateTime(2025, 1, 7, 11, 44, 0, 432, DateTimeKind.Local).AddTicks(8641),
                            ProviderUserId = "2",
                            TargetStudentUserId = "1"
                        });
                });
            ...
            modelBuilder.Entity("Banha_UniverCity.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d29c41fd-064b-4d0b-bb5c-f8b15d389e0f",
                            ...
                            SecurityStamp = "8ad23b77-dc7c-4edf-8678-1ea1a70700f0",
                        ...
                        new
                        {
                            Id = "2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "446ac065-6852-420e-a9f0-be9138f7987b",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2fad0b89-a5da-4060-8f8a-7bc18736c46a",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "123548458",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cd490c9e-580e-4d3f-96eb-01b2d9e53a46",
                            Email = "Admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEO7cHLxJsrCPKFPM7LBETwzPsE157fJfWdtsSNOuiVyP7zdqUjpeh6li0x/z19PL5g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "789b66be-2202-4ce7-bc50-68c7f62cb3d7",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BFCAI.Models.Reaction", b =>
                {
                    b.HasOne("BFCAI.Models.Comment", null)
                        .WithMany("Reactions")
                        .HasForeignKey("TargetId")
                        .HasConstraintName("FK_Reaction_Comment");

                    b.HasOne("BFCAI.Models.Post", null)
                        .WithMany("Reactions")
                        .HasForeignKey("TargetId")
